...
本章节可帮助您安装Temporal服务并实施工作流。

## 在本地安装Temporal Server

要在本地运行示例，您需要参阅[说明](https://docs.temporal.io/docs/install-temporal-server/)在本地运行Temporal服务。
...
查看 [Go SDK Samples](https://github.com/temporalio/go-samples)
然后尝试简单的 Temporal 使用场景。
